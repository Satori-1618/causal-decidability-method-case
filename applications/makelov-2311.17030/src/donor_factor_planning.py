"""Mechanical, assumption-dependent Round-3A confirmation size calculation.
...
def plan_confirmation(summary_or_records, gaussian_simulations=GAUSSIAN_SIMULATIONS,
    ...
    result = {"schema_version": "donor-factor-planning-v1", "status": "STOP",
    ...
    for index, n in enumerate(CANDIDATE_SIZES):
        ...
        if candidate["passes"]:
            ...
            return result
    result["stop_reason"] = "no prespecified n <=384 meets coverage and every mean planning gate"
    return result
